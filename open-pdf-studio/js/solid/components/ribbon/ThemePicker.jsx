...
const THEME_OPTIONS = [
  { value: 'default', labelKey: 'theme.default', swatches: ['#3E3636', '#4a4242', '#D97706', '#F5F0EB'] },
  ...
  { value: 'amber-navy', labelKey: 'theme.amberNavy', swatches: ['#1a1a2e', '#242445', '#D97706', '#C4B199'] },
